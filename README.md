# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Direct Fulfillment Inventory Updates
...
```shell
composer require bricre/amazon-selling-partner-sdk-vendor-direct-fulfillment-inventory
```
...
```php
<?php
use Amz\VendorDirectFulfillmentInventory\ResponseTypes;
